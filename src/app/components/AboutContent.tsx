  ...
  return (
    <section className="space-y-6">
      ...
      <InfoSection
        ...
        items={contactInfo}
        cardClass="bg-[#ECE9D8] border-[#ACACAC] hover:bg-[#F5F3EB]"
      />
      ...
      <InfoSection
        title="Social Media"
        items={socialLinks}
        cardClass="bg-white border-[#0054E3] hover:bg-blue-50 cursor-pointer"
        external
      />
      ...
      {items.map(({ icon: Icon, label, value, color, href }) => {
        ...
        return (
          <Wrapper
            ...
            className={`flex items-center gap-3 p-3 border-2 rounded transition-colors ${cardClass}`}
          >
            <div
...
function ContactForm() {
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full px-4 py-2 bg-gradient-to-b from-[#3F8CF3] to-[#0054E3] text-white rounded border-2 border-[#0054E3] hover:brightness-110 transition-all"
      >
        Send Message
      </button>
    </form>
